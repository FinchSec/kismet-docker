...
RUN apt-get update && \
    ...
    apt-get install -y --no-install-recommends ca-certificates git gcc make libc6-dev libmicrohttpd-dev \
                    ...
                    protobuf-c-compiler libsensors-dev python3 python3-setuptools python3-protobuf libssl-dev \
                    python3-usb python3-numpy python3-dev python3-pip python3-serial librtlsdr0 libmosquitto-dev \
...
RUN apt-get update && \
    ...
    apt-get install -y --no-install-recommends libc6 libmicrohttpd12 zlib1g libnl-3-200 libnl-genl-3-200 libssl3t64 \
                    ...
                    python3-pip python3-serial librtlsdr0 libusb-1.0-0 rtl-433 openssl libpreludecpp12 libmosquitto1 \
